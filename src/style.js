const styles = {
    ...
    textGradient: "text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-[#77BBF1]",
    ...
    paddingX: "xs:px-8 ss:px-10 sm:px-16 px-24",
    paddingY: "xs:py-10 ss:py-12 sm:py-16 py-24 ",
